			...
			<form id="myform" method="post">
				<ul class="zh_message">
					<li>
						...
						<span class="r"><input type="password" class="required" name="old_password" id="old_pwd" /></span>
					</li>
					<li>
						<span class="l">新密码：</span>
						<span class="r"><input type="password" class="required"  name="new_password" id="new_pwd"/></span>
					</li>
					<li>
						<span class="l">确认密码：</span>
						<span class="r"><input type="password"  class="required" name="new_password_confirm" id="confirm_pwd"/></span>
					</li>
