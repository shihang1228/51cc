...
<div class="member_wrap" >
    ...
    <div class="right index">
        <p class="welcome">2016年08月28日  尊敬的 <span class="color_f90"><?php echo ($userdata['username']); ?>(<?php echo ($userdata['phone']); ?>)</span>，欢迎来到找磁材网会员中心！<a href="http://jr.zhaosuliao.com/my" style="margin-left: 60px; color: #3232FF;">申请金融服务</a></p>
        <div class="apply_vip">
